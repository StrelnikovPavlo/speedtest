 ...
 */
    ...
    (() => {
            ...
            async function formSubmitAction(form, e) {
                ...
                if (error === 0) {
                    ...
                    if (ajax) {
                        ...
                        try {
                            let response = {};
                            if (formMethod.toLowerCase() === "get") response = await fetch(`${formAction}?=${jsonData.search}`, {
                                method: formMethod,
                                headers: {
                                    "Content-Type": "application/json"
                                }
                            }); else response = await fetch(formAction, {
                                method: formMethod,
                                headers: {
                                    "Content-Type": "application/json"
                                },
        ...
        class DefaultOptionsCalendar {
            constructor() {
                ...
                __publicField(this, "months", 2), __publicField(this, "jumpMonths", 1), __publicField(this, "date", {
                    ...
                    hideCalendar: null,
                    showCalendar: null
                }), __publicField(this, "popups", {}), __publicField(this, "CSSClasses", __spreadValues({}, classes)), 
        ...
        const getDateString = e => `${e.getFullYear()}-${String(e.getMonth() + 1).padStart(2, "0")}-${String(e.getDate()).padStart(2, "0")}`, getDate = e => new Date(`${e}T00:00:00`), parseDates = e => e.reduce(((e, t) => (t.match(/^(\d{4}-\d{2}-\d{2})$/g) ? e.push(t) : t.replace(/(\d{4}-\d{2}-\d{2}).*?(\d{4}-\d{2}-\d{2})/g, ((t, a, n) => {
            ...
            e.rangeMin = s || e.settings.range.disableAllDays ? getDateString(e.date.today) : e.settings.range.min, 
            e.rangeMax = e.settings.range.disableAllDays ? getDateString(e.date.today) : e.settings.range.max, 
            e.rangeDisabled = e.settings.range.disabled && !e.settings.range.disableAllDays ? parseDates(e.settings.range.disabled) : e.settings.range.disableAllDays ? [ e.rangeMin ] : [], 
            ...
            for (let t = e.viewYear - 7; t < e.viewYear + 8; t++) {
                const r = t < e.dateMin.getFullYear() + s || t > e.dateMax.getFullYear(), i = createYearEl(e, l, a, r, t);
            ...
            c.type = "button";
            for (let t = 0; t < 12; t++) {
                const a = e.locale.months[t], n = t < e.dateMin.getMonth() + relationshipID(e) && r <= e.dateMin.getFullYear() || t > e.dateMax.getMonth() + relationshipID(e) && r >= e.dateMax.getFullYear() || t !== s && !d.includes(t), l = createMonthEl(e, c, s, a, n, t);
            ...
            var a;
            if (a = t, setTheme(e.HTMLElement, a.matches ? "dark" : "light"), "system" !== e.settings.visibility.theme || haveListener.check()) return;
            const n = t => {
                const a = document.querySelectorAll(`.${e.CSSClasses.calendar}`);
                null == a || a.forEach((e => setTheme(e, t.matches ? "dark" : "light")));
            };
            ...
            if (!a) return void trackChangesThemeInSystemSettings(e, t);
            ...
            ({
                ...
                system: () => detectTheme(e, window.matchMedia("(prefers-color-scheme: dark)"))
            ...
            }, l = Array.isArray(a) ? a[0] : "bottom", r = Array.isArray(a) ? a[1] : a;
            ...
            const n = () => setPositionCalendar(e.HTMLInputElement, e.HTMLElement, e.settings.visibility.positionToInput, e.CSSClasses), s = t => {
                var a;
                e && t.target !== e.HTMLInputElement && !(null == (a = e.HTMLElement) ? void 0 : a.contains(t.target)) && (e.HTMLInputElement && e.HTMLElement && actionsInput(e).hide(), 
                window.removeEventListener("resize", n), document.removeEventListener("click", s, {
                    capture: !0
                }));
            };
            return e.HTMLInputElement.addEventListener("click", (() => {
                t ? a.push((() => {
                    ...
                    return a.className = `${e.CSSClasses.calendar} ${e.CSSClasses.calendarToInput} ${e.CSSClasses.calendarHidden}`, 
                    e.HTMLElement = a, document.body.append(e.HTMLElement), t = !1, setTimeout((() => {
                        setPositionCalendar(e.HTMLInputElement, a, e.settings.visibility.positionToInput, e.CSSClasses), 
                        actionsInput(e).show();
                    }), 0), update(e, {
                        year: !0,
                        month: !0,
                ...
                })()) : (setPositionCalendar(e.HTMLInputElement, e.HTMLElement, e.settings.visibility.positionToInput, e.CSSClasses), 
                actionsInput(e).show()), window.addEventListener("resize", n), document.addEventListener("click", s, {
                    capture: !0
                });
            })), () => {
                a.forEach((e => e()));
        ...
        class VanillaCalendar extends DefaultOptionsCalendar {
            constructor(e, t) {
                if (super(), __publicField(this, "init", (() => {
                    ...
                    e.input ? handleInput(e) : (setVariables(e), create(e), handleClick(e));
                    var e;
                })), __publicField(this, "update", (e => update(this, e))), __publicField(this, "destroy", (() => destroy(this))), 
        ...
        const reservationSubmitBtn = document.querySelector(".info-reservation__submit");
        if (calendar) {
            const timePickerItems = document.querySelectorAll(".time-picker-reservation__item");
            async function initializeCalendar() {
                function getDisabledDays() {
                    return fetch(`https://romanova-mental.com/api/v1/weekdays`, {
                        method: "GET",
                        headers: {
                        ...
                        const disabledDays = [];
                        data.forEach((day => {
                            if (!day.is_available) disabledDays.push(day.weekday);
                        }));
                        return disabledDays;
                    })).catch((error => {
                ...
                const inactiveWeekdays = await getDisabledDays();
                const getDate = addedMonths => {
                    const today = new Date;
                    if (addedMonths) today.setMonth(today.getMonth() + addedMonths);
                ...
                const options = {
                    ...
                    actions: {
                        ...
                        getDays(day, date, HTMLElement, HTMLButtonElement) {
                            ...
                            if (inactiveWeekdays.includes(dayOfWeek)) HTMLButtonElement.classList.add("vanilla-calendar-day__btn_disabled");
                        }
                    }
                };
            ...
            function updateReservationDate(selectedDate) {
                ...
                if (!isNaN(selectedDate.getTime()) && typeof selectedDate.toISOString === "function") {
                    ...
                    if (inputDate) {
                        inputDate.value = isoDateString;
                        reservationSubmitBtn.classList.add("info-reservation__submit-disabled");
                        timePickerItems.forEach((item => {
                            item.classList.remove("selected");
                        }));
                    }
        ...
        if (inputMasks.length) modules_flsModules.inputmask = Inputmask("+38 (099) 999-99-99", {
            placeholderVisible: "always"
        }).mask(inputMasks);
        ...
        function initSliders() {
            ...
            if (document.querySelector(".certificates__slider-wrapper")) {
                const sliderWrapper = document.querySelector(".certificates__slider-wrapper");
                let slides = Array.from(document.querySelectorAll(".swiper-slide"));
                const prevButton = document.querySelector(".certificates__slider-nav--prev");
                const nextButton = document.querySelector(".certificates__slider-nav--next");
                ...
                function updateSliderPosition() {
                    let offset = 0;
                    for (let i = 0; i < currentIndex; i++) offset += slides[i].clientWidth + 20;
                ...
                function createPagination() {
                    slides.forEach(((_, index) => {
                        ...
                        paginationDot.classList.add("swiper-pagination-bullet");
                        paginationDot.addEventListener("click", (() => goToSlide(index)));
                        paginationContainer.appendChild(paginationDot);
                    }));
                    updatePagination();
                }
                function updatePagination() {
                    paginationContainer.childNodes.forEach(((dot, index) => {
                ...
                function updateSlidesPerView() {
                    ...
                    let slidesPerView = 1;
                    if (windowWidth >= 992) slidesPerView = breakpoints[992]; else if (windowWidth >= 768) slidesPerView = breakpoints[768]; else if (windowWidth >= 650) slidesPerView = breakpoints[650];
                    slides.forEach((slide => {
                        if (!slide.classList.contains("double-width")) {
                            if (slidesPerView === 1) slide.style.flex = `0 0 calc(${100 / slidesPerView}%)`;
                            slide.style.flex = `0 0 calc(${100 / slidesPerView}% - 20px)`;
                        }
                        if (slide.classList.contains("double-width")) if (slidesPerView === 1 || slidesPerView === 2) slide.style.flex = `0 0 calc(${100}%)`; else if (slidesPerView === 3) slide.style.flex = `0 0 calc(${100 / 3 * 2}% - 20px)`;
                    }));
                    updateSliderPosition();
                }
        ...
        function moveFilterBlock() {
            ...
            if (materialsContainer) {
                ...
                if (screenWidth <= 767) materialsContainer.insertBefore(filterBlock, document.querySelector(".materials__title").nextSibling); else {
                    ...
                    materialsItems.insertBefore(filterBlock, materialsItems.children[0]);
                }
            }
        }
