(() => {
    ...
    var __webpack_modules__ = {
        ...
        426: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
            __webpack_require__.d(__webpack_exports__, {
                n1: () => formValidate
            });
            var _modules_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(908);
            ...
            let formValidate = {
                ...
                formClean(form) {
                    ...
                    setTimeout((() => {
                        ...
                        if (_modules_js__WEBPACK_IMPORTED_MODULE_0__.t.select) {
                            let selects = form.querySelectorAll(".select");
                            if (selects.length) for (let index = 0; index < selects.length; index++) {
                                const select = selects[index].querySelector("select");
                                _modules_js__WEBPACK_IMPORTED_MODULE_0__.t.select.selectBuild(select);
                            }
                        }
                    }), 0);
                },
        ...
        260: (__unused_webpack___webpack_module__, __unused_webpack___webpack_exports__, __webpack_require__) => {
            var _files_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(68);
            var _files_modules_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(908);
            var _files_forms_forms_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(426);
            class SelectConstructor {
                ...
                selectСlose(selectItem) {
                    ...
                    if (!selectOptions.classList.contains("_slide")) {
                        ...
                        (0, _files_functions_js__WEBPACK_IMPORTED_MODULE_0__.ws)(selectOptions, originalSelect.dataset.speed);
                        setTimeout((() => {
                ...
                selectAction(selectItem) {
                    ...
                    setTimeout((() => {
                        if (!selectOptions.classList.contains("_slide")) {
                            ...
                            (0, _files_functions_js__WEBPACK_IMPORTED_MODULE_0__.X_)(selectOptions, originalSelect.dataset.speed);
                ...
                setSelectChange(originalSelect) {
                    if (originalSelect.hasAttribute("data-validate")) _files_forms_forms_js__WEBPACK_IMPORTED_MODULE_2__.n1.validateInput(originalSelect);
                ...
                setLogging(message) {
                    this.config.logging ? (0, _files_functions_js__WEBPACK_IMPORTED_MODULE_0__.yU)(`[select]: ${message} `) : null;
                }
            }
            _files_modules_js__WEBPACK_IMPORTED_MODULE_1__.t.select = new SelectConstructor({});
        }
    };
