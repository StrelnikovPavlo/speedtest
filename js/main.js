 ...
 */
        ...
        426: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
            ...
            var _functions_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(68);
            var _scroll_gotoblock_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(303);
            ...
            function formSubmit() {
                ...
                async function formSubmitAction(form, e) {
                    ...
                    if (error === 0) {
                        ...
                        if (form.querySelector("._form-error") && form.hasAttribute("data-goto-error")) {
                            ...
                            (0, _scroll_gotoblock_js__WEBPACK_IMPORTED_MODULE_2__.j)(formGoToErrorClass, true, 1e3);
                        }
                    }
                }
                function formSent(form, jsonData, responseResult = ``) {
                    ...
                    setTimeout((() => {
                        if (_modules_js__WEBPACK_IMPORTED_MODULE_0__.t.popup) {
                            const popup = form.dataset.popupMessage;
                            popup ? _modules_js__WEBPACK_IMPORTED_MODULE_0__.t.popup.open(popup) : null;
                        }
                    }), 0);
                ...
                function formLogging(message) {
                    (0, _functions_js__WEBPACK_IMPORTED_MODULE_1__.yU)(`[Форми]: ${message}`);
                }
            }
        ...
        789: (__unused_webpack___webpack_module__, __unused_webpack___webpack_exports__, __webpack_require__) => {
            "use strict";
            var _modules_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(908);
            __webpack_require__(958);
            const inputMasks = document.querySelectorAll('input[type="tel"]');
            if (inputMasks.length) _modules_js__WEBPACK_IMPORTED_MODULE_0__.t.inputmask = Inputmask("+38 (099) 999-99-99", {
        ...
        674: (__unused_webpack___webpack_module__, __unused_webpack___webpack_exports__, __webpack_require__) => {
            "use strict";
        ...
        303: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
            ...
            let gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
                ...
                if (targetBlockElement) {
                    ...
                    document.documentElement.classList.contains("menu-open") ? (0, _functions_js__WEBPACK_IMPORTED_MODULE_0__.KT)() : null;
                    ...
                    (0, _functions_js__WEBPACK_IMPORTED_MODULE_0__.yU)(`[gotoBlock]: Юхуу...їдемо до ${targetBlock}`);
                } else (0, _functions_js__WEBPACK_IMPORTED_MODULE_0__.yU)(`[gotoBlock]: Йой... Такого блоку немає на сторінці: ${targetBlock}`);
            };
        },
        577: (__unused_webpack___webpack_module__, __unused_webpack___webpack_exports__, __webpack_require__) => {
            "use strict";
            var vanilla_lazyload__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(144);
        ...
        774: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
            "use strict";
            __webpack_require__.d(__webpack_exports__, {
                Ns: () => headerScroll
            });
        ...
        804: (__unused_webpack___webpack_module__, __unused_webpack___webpack_exports__, __webpack_require__) => {
            "use strict";
            ...
            class Popup {
                ...
                open(selectorValue) {
                    if (_files_functions_js__WEBPACK_IMPORTED_MODULE_0__.uy) {
                        ...
                        if (this.targetOpen.element) {
                            ...
                            if (!this._reopen) !this.bodyLock ? (0, _files_functions_js__WEBPACK_IMPORTED_MODULE_0__.mh)() : null; else this._reopen = false;
                ...
                close(selectorValue) {
                    ...
                    if (!this.isOpen || !_files_functions_js__WEBPACK_IMPORTED_MODULE_0__.uy) return;
                    ...
                    if (!this._reopen) {
                        ...
                        !this.bodyLock ? (0, _files_functions_js__WEBPACK_IMPORTED_MODULE_0__.dI)() : null;
                        this.isOpen = false;
                    }
                    this._removeHash();
                ...
                popupLogging(message) {
                    this.options.logging ? (0, _files_functions_js__WEBPACK_IMPORTED_MODULE_0__.yU)(`[Попапос]: ${message}`) : null;
                }
            }
            _files_modules_js__WEBPACK_IMPORTED_MODULE_1__.t.popup = new Popup({});
        }
    };
    ...
    (() => {
        "use strict";
        var _files_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(68);
        var _files_forms_forms_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(426);
        __webpack_require__(804);
        __webpack_require__(789);
        __webpack_require__(577);
        var _files_scroll_scroll_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(774);
        __webpack_require__(320);
        __webpack_require__(674);
        window["FLS"] = false;
        _files_functions_js__WEBPACK_IMPORTED_MODULE_0__.vE();
        _files_functions_js__WEBPACK_IMPORTED_MODULE_0__.mU();
        _files_forms_forms_js__WEBPACK_IMPORTED_MODULE_1__.oL({
            viewPass: false,
            autoHeight: false
        });
        _files_forms_forms_js__WEBPACK_IMPORTED_MODULE_1__.tN();
        _files_scroll_scroll_js__WEBPACK_IMPORTED_MODULE_5__.Ns();
    })();
})();